import Dice from "../systems/Dice";

export const normalDie = new Dice('Normal Die', [.1667, .1667, .1667, .1667, .1667, .1667]);
export const adamsDie = new Dice(`Adam's Die`, [.286, .048, .286, .048, .286, .048]);
...
export const diceList = [
    normalDie, adamsDie, cheatersDie, ciDie, devilsDie, misfortuneDie,
